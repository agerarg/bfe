...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],$skill['idSkill'],164,600);
		}	
...
{
	insertBuff($pj['idPersonaje'],$skill['idSkill'],164,600);
}

$data['aura'][] = array("idSkill"=>164,"lvl"=>$skill['nivel'],"auraTimeOut"=>600,"pasive"=>0);
