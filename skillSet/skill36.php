...
{
	case 1:
		$ataque_player = $stats['Ataque']*8 + $stats['skillPowerAcumulate'];
	break;
}
///Blooddd

if($stats['DestructorBlowDmg']>0)
	$ataque_player=potenciar($ataque_player,$stats['DestructorBlowDmg']);

$vidaModifier = $vidaModifier+$stats['SkillDmg'];
