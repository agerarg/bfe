...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],107,65,1200,$log->get("pjSelected"));
		}	
...
{
	insertBuff($pj['idPersonaje'],107,65,1200,$log->get("pjSelected"));
}
$data['aura'][] = array("idSkill"=>65,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
