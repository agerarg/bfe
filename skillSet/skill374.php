...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],524,374,1200);
		}	
...
{
	insertBuff($pj['idPersonaje'],524,374,1200);
}
$data['aura'][] = array("idSkill"=>374,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
