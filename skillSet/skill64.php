...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],106,64,1200,$log->get("pjSelected"));
		}	
...
{
	insertBuff($pj['idPersonaje'],106,64,1200,$log->get("pjSelected"));
}
$data['aura'][] = array("idSkill"=>64,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
