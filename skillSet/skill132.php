...
{
	case 1:
		$heal = intval($stats['AtaqueMagico']*1.5)+3000;
	break;
}

if($stats['DesperateHealDmg']>0)
	$heal=potenciar($heal,$stats['DesperateHealDmg']);
...
if($pj['party']>0)
{
	...
	$msgs = "<spam class='healSkill'>".$pj['nombre']." te curo ".$heal.$criticolo." de vida!</spam>";
