...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],517,370,1200);
		}	
...
{
	insertBuff($pj['idPersonaje'],517,370,1200);
}

	
$data['aura'][] = array("idSkill"=>370,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
