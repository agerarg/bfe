...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],$skill['idSkill'],125,1200);
		}	
...
{
	insertBuff($pj['idPersonaje'],$skill['idSkill'],125,1200);
}

$data['aura'][] = array("idSkill"=>125,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
