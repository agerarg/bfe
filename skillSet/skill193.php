...
if($pj['party']>0)
{
	$query = 'SELECT idPersonaje
		...
		{
			insertBuff($targets['idPersonaje'],333,193,1200);
		}	
...
{
	insertBuff($pj['idPersonaje'],333,193,1200);
}
$data['aura'][] = array("idSkill"=>193,"lvl"=>$skill['nivel'],"auraTimeOut"=>1200,"pasive"=>0);
