		...
		/////// ALLLLL
					if($tipoRoll!=2)
					{
						...
						if($masterWork)
							...
							$leyenda .= $attr." (".balanceStatMin($maxSkill1)."/".$maxSkill1.") <br>";
					}
					if($tipoRoll!=1)
					{
						$attr="AtaqueMagico";
					...
					if($tipoRoll!=2)
					{
						...
						$leyenda .= $attr." (".balanceStatMin($maxSkill3)."/".$maxSkill3.") <br>";
					}
					if($tipoRoll!=1)
					{
						$attr="CriticoMagico";
					...
					if($masterWork)
							...
							$leyenda .= $attr." (".balanceStatMin($maxSkill2)."/".$maxSkill2.") <br>";
					$attr="DefensaMagica";
					if($masterWork)
							$leyenda .= $attr." (".($maxSkill2*3).") <br>";
						else
					...
					$leyenda .= $attr." (".balanceStatMin($maxSkill4)."/".$maxSkill4.") <br>";
					$attr="ManaLimit";
					if($masterWork)
							$leyenda .= $attr." (".($maxSkill4*3).") <br>";
						else
					...
					$attr="HpRegen";
						...
						$leyenda .= $attr." (".balanceStatMin($maxSkill5)."/".$maxSkill5.") <br>";
					$attr="MpRegen";
					if($masterWork)
							$leyenda .= $attr." (".($maxSkill5*3).") <br>";
						else
